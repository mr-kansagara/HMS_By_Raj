...
namespace HMS.Controllers
{
    ...
    public class RptExpensesController : Controller
    {
        ...
        private readonly ILogger<RptExpensesController> _logger;

        public RptExpensesController(ApplicationDbContext context, ICommon iCommon, ILogger<RptExpensesController> logger)
        {
            _context = context;
            _iCommon = iCommon;
            _logger = logger;
        ...
        public IActionResult GetDataTableData()
        {
            ...
            {
                _logger.LogError(ex, "Error in getting Rpt Expenses.");
                throw;
            }
