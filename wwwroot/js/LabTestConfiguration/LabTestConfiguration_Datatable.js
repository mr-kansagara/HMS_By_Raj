$(document).ready(function () {
    document.title = 'Lab Test Configuration';

    $("#tblLabTestConfiguration").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/LabTestConfiguration/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            { "data": "LabTestsId", "name": "LabTestsId" },
            { "data": "Sorting", "name": "Sorting" },
            { "data": "ReportGroup", "name": "ReportGroup" },
            { "data": "NameOfTest", "name": "NameOfTest" },
