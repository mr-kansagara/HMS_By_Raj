$(document).ready(function () {
    document.title = 'Insurance Company Info';

    $("#tblInsuranceCompanyInfo").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/InsuranceCompanyInfo/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "initComplete": function (settings, json) {
            var column = this.api().column(7); // Index of the "Hospital" column
