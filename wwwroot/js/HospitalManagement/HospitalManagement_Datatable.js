        ...
        "columns": [
            ...
            },
            {
                data: null, "sortable": false, render: function (data, type, row) {
                    return "<a href='#' class='d-block' onclick=ViewImage('" + row.ProfilePicture + "','Hospital_Image');><div class='image'><img src='" + row.ProfilePicture + "' class='img50px img-circle elevation-2' alt='Asset Image'></div></a>";
                }
            }, 
            {
