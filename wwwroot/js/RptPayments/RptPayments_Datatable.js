...
var CustomRangeDataFilter = function () {
    ...
    location.href = "/RptPayments/Index?StartDate= " + _StartDate + "&EndDate= " + _EndDate;
};


var LoadDataTables = function () {
    document.title = 'Payments Report';
    $("#tblPaymentsReport").DataTable({
        ...
        "ajax": {
            "url": "/RptPayments/GetDataTableData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            { "data": "InsuranceNo", "name": "InsuranceNo" },
