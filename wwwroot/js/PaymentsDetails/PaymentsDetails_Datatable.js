$(document).ready(function () {
    document.title = 'PaymentsDetails';

    $("#tblPaymentsDetails").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/PaymentsDetails/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            { "data": "PaymentsId", "name": "PaymentsId" },
{ "data": "PaymentCategoriesId", "name": "PaymentCategoriesId" },
{ "data": "ChargeAmount", "name": "ChargeAmount" },
